...
const Services = () => {
  ...
  return (
    <div className="py-[250px] px-[200px] justify-items-end bg-[url('../../public/Icons/FrameImageSvg/Frame.svg')] bg-right-bottom min-h-screen bg-no-repeat max-w-[2200px]">
      <div className="">
        <div className="element w-200 h-200 bg-blue animate-moveToLeft animation-delay-10">
          <div className="w-[460px] ">
            <h1 className="text-32 text-green-800 text-[32px] uppercase tracking-wider leading-115 font-bold">
              იუსტიციის სახლის სერვისები
            </h1>
          </div>

          <div className="text-black text-base font-normal w-[578px]">
            <span>
              იუსტიციის სახლის მიზანია მომხმარებლისათვის სახელმწიფო და კერძო სექტორის სერვისების მაღალი
              ხარისხით მიწოდება
            </span>
          </div>
          ...
          <div className="flex mt-14 shadow-md h-[60px] w-[1194px]  flex-col justify-center items-center  border-radius-24 bg-opacity-50 bg-white ">
            <div className="flex  p-[4px] h-[52px] items-start self-stretch rounded-3xl bg-white ">
              ...
              <ul className="flex justify-between">
                <li
                  className="flex justify-center items-center w-[180px] rounded-3xl hover:bg-gray-300 active:bg-lime-300 "
                  onClick={openModal}
                >
                ...
                <li
                  className="flex p-[10px] justify-center items-center rounded-3xl w-[180px] hover:bg-gray-300 active:bg-lime-300"
                >
                ...
                <li
                  className="flex p-[10px] w-[180px] justify-center rounded-3xl items-center hover:bg-gray-300 active:bg-lime-300  "
                >
                ...
                <li
                  className="flex w-[180px] p-[10px] items-center rounded-3xl justify-center hover:bg-gray-300 active:bg-lime-300 "
                >

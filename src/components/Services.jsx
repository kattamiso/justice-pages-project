...
<div className="py-[250px] px-[200px] justify-items-end bg-[url('../../public/Icons/FrameImageSvg/Frame.svg')] bg-right-bottom min-h-screen bg-no-repeat max-w-[2200px]">  
  <div className="">
      ...
      <div className="flex mt-14  h-[60px] w-[1194px]  flex-col justify-center items-center  border-radius-24 bg-opacity-50 bg-white ">
  <div className="flex p-[4px] h-[52px] items-start self-stretch rounded-3xl bg-white ">
    
    <ul className="flex justify-between">
    <li className="flex justify-center items-center w-[180px] rounded-3xl hover:bg-gray-300 active:bg-lime-300">
